...
//  Project20
//
//  Created by Meitar Basson on 30/09/2024.
//
...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        gameTimer = Timer.scheduledTimer(timeInterval: 6, target: self, selector: #selector(launchFireworkds), userInfo: nil, repeats: true)
    }
    
    func createFirework(xMovement: CGFloat, x: Int, y: Int) {
        if numberOfLaunches == 5 * numberOfRounds {
